...
function getOverlayMiddleware(options) {
    function getSourceById(isFile, id) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var fileContent, map_1, compilation, m;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        try {
                            compilation = (_a = options.stats()) === null || _a === void 0 ? void 0 : _a.compilation;
                            m = (_b = compilation === null || compilation === void 0 ? void 0 : compilation.modules) === null || _b === void 0 ? void 0 : _b.find(function (m) { return m.id === id; });
                            return [2 /*return*/, ((_c = m === null || m === void 0 ? void 0 : m.source(compilation.dependencyTemplates, compilation.runtimeTemplate)) !== null && _c !== void 0 ? _c : null)];
                        }
                        catch (err) {
    ...
    return function (req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _p, pathname, query, frame, moduleId, source, err_1, frameLine, frameColumn, pos, consumer, err_2, filePath, fileContent, originalFrame, originalCodeFrame, o, frame, frameFile, filePath, fileExists, frameLine, frameColumn, err_3;
            return __generator(this, function (_q) {
                switch (_q.label) {
                    case 0:
                        _p = url_1["default"].parse(req.url, true), pathname = _p.pathname, query = _p.query;
                        if (!(pathname === '/__nextjs_original-stack-frame')) return [3 /*break*/, 10];
                        frame = query;
                    ...
                    case 1:
                        _q.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, getSourceById(frame.file.startsWith('file:'), moduleId)];
                    case 2:
                        source = _q.sent();
                        return [3 /*break*/, 4];
                    case 3:
                    ...
                    case 5:
                        _q.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, new source_map_1.SourceMapConsumer(source.map())];
                    case 6:
                        consumer = _q.sent();
                    ...
                    case 8:
                        ...
                        filePath = path_1["default"].resolve(options.rootDirectory, pos.source.startsWith('webpack:///')
                            ? pos.source.substring(11)
                            : pos.source);
                        return [4 /*yield*/, fs_1.promises
                                .readFile(filePath, 'utf-8')["catch"](function () { return null; })];
                    case 9:
                        fileContent = _q.sent();
                        originalFrame = {
                            file: fileContent
                                ? path_1["default"].relative(options.rootDirectory, filePath)
                                : pos.source,
                            lineNumber: pos.line,
                            column: pos.column,
                        ...
                        originalCodeFrame = fileContent && pos.line
                            ? code_frame_1.codeFrameColumns(fileContent, { start: { line: pos.line, column: pos.column } }, { forceColor: true })
                            : null;
                        o = {
                        ...
                        return [2 /*return*/, res.end()];
                    case 10:
                        if (!(pathname === '/__nextjs_launch-editor')) return [3 /*break*/, 16];
                        frame = query;
...
exports["default"] = getOverlayMiddleware;
